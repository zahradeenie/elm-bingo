			...
			case 'NewGame':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{entries: _user$project$Bingo$initialEntries}),
					_1: _user$project$Bingo$generateRandomNumber
				};
			case 'Mark':
...
var _user$project$Bingo$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$Bingo$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
